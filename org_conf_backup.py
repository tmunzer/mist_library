...
def _backup_full_org(mist_session, org_id, org_name):
    ...
    for site in sites:
        ...
        assetfilters = _do_backup(mist_session, backup_function, site_id, "Site assetfilters")

        backup_function = mist_lib.requests.sites.beacons.get
        # backup_function = mist.sites_beacons_api.get_site_beacons
        beacons = _do_backup(mist_session, backup_function, site_id, "Site beacons")
