...
def _deploy_inventory(dst_mist_session:mistapi.APISession, src_mist_session:mistapi.APISession, dst_org_id:str, dst_org_name:str, src_org_name:str, backup_folder_param:str, unclaim:bool=False, unclaim_all:bool=False):
    _print_new_step("Pre-check for INVENTORY restoration")
    org_inventory_deploy.start(
...
def start(src_apisession: mistapi.APISession, dst_apisession: mistapi.APISession=None, src_org_id:str=None, src_org_name:str=None, dst_org_id:str=None, dst_org_name=None, backup_folder_param:str=None, unclaim:bool=False, unclaim_all:bool=False):    
    '''
...
if __name__ == "__main__":
    try:
        opts, args = getopt.getopt(sys.argv[1:], "hl:b:ua", [
                                   "help", "src_org_id=", "src_org_name=", "dst_org_id=", "dst_org_name=", "dst_env=", "src_env=", "log_file=", "backup_folder=", "unclaim", "unclaim_all"])
